...
Plans:
- [x] 21-01-PLAN.md — discovery contracts, homepage list, and category URL sync
...
Plans:
- [x] 23-01-PLAN.md — social contracts, nested threads, replies, and reaction toggles
...
| 23 | SOC-01..SOC-03 | Completed | 1/1 plans |
