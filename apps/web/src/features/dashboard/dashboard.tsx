...
interface PricingDisplayChapterRow {
  id: number;
  title: string;
  accessLabel: string;
...
export function DashboardView() {
  ...
  function renderPurchasesSection() {
    ...
    const comboHistoryReady =
      comboPurchaseHistoryState.status === "ready" ? comboPurchaseHistoryState.data : null;
    ...
    return (
      <section className="dashboard-purchases" aria-label="Purchases section">
              ...
              {pricingDisplay.chapterRows.length > 0 ? (
                <div className="dashboard-purchase-history-table-wrap">
                  <table className="dashboard-purchase-history-table">
                    ...
                    <tbody>
                      {pricingDisplay.chapterRows.map((row: PricingDisplayChapterRow) => (
                        <tr key={row.id}>
                          <td>{row.title}</td>
        ...
        <article className="dashboard-purchases-list dashboard-purchases-list--combo">
          ...
          comboPurchaseHistoryState.status === "idle" ? (
          ...
          ) : comboHistoryReady && comboHistoryReady.items.length === 0 ? (
            ...
            <div className="dashboard-purchase-history-table-wrap">
              <table className="dashboard-purchase-history-table">
                ...
                <tbody>
                  {comboHistoryReady?.items.map((item: ComboPurchaseHistoryResponse["items"][number]) => (
