...
export function NovelDetail({ novelId, backPath = "/dashboard/novels" }: NovelDetailProps) {
  ...
  async function handleImportFile(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    setChapterMessage(`Đã nhập ${chaptersCreated.length} chương.${note}`);
  }
  ...
  return (
    <div className="flex flex-col gap-6 max-w-4xl">
      ...
      <div className="rounded-lg border border-border bg-card p-6">
        <div className="flex items-start justify-between gap-4 mb-5">
          <div>
            ...
            <p className="text-sm text-muted-foreground">ID #{novel.id} · Uploader #{novel.uploaderId}</p>
          </div>
          <DropdownMenu>
        ...
        <form onSubmit={handleNovelSave} className="flex flex-col gap-5">
          {/* Basic info */}
          <div className="flex flex-col gap-1.5">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              id="novel-content"
              className="shd-textarea min-h-28 w-full"
      ...
      <div className="rounded-lg border border-border bg-card">
        ...
        {chapterMessage && (
          <p className="px-6 py-2 text-sm text-emerald-600 dark:text-emerald-400 border-b border-border">
            {chapterMessage}
          </p>
        )}
          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="border-b border-border bg-muted/40">
                ...
                <th className="px-4 py-3 text-left font-medium text-muted-foreground hidden md:table-cell">Số chương</th>
                <th className="px-4 py-3 text-left font-medium text-muted-foreground hidden md:table-cell">Giá (xu)</th>
